...
const sendMarsTemperature = (funDeley , funTemperature) => {
    const times = funDeley();
    const temperature = funTemperature();
    setTimeout(() => console.log(`Mars temperature is: ${temperature} degree Celsius`), times);
}
