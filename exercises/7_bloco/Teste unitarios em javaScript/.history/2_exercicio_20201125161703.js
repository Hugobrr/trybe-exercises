...
assert.ok( assert.deepEqual(expected_2, [ 1, 2, 4 ] , "Deve-se retornar o arry da forma correta") & assert.deepEqual(array_exemplo,[1, 2, 3, 4],"Se o array de entrada não foi modificado ."  ) )
